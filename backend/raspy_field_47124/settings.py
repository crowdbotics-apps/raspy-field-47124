"""
Django settings for raspy_field_47124 project.
...
ROOT_URLCONF = 'raspy_field_47124.urls'
...
WSGI_APPLICATION = 'raspy_field_47124.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "raspy_field_47124 API",
    "DESCRIPTION": "API documentation for raspy_field_47124 App",
    "VERSION": "v1",
}
